                ...
                <div className="checkout__left__mid__product">
                    ...
                    <div className="checkout__left__mid__productInfo">
                        <div className="checkout__left__mid__productInfo__name">
                            Sceptre IPS 27-Inch Business Computer Monitor 1080p 75Hz with HDMI VGA Build-in Speakers,
                            Machine Black 2020 (E275W-FPT), 27" IPS 75Hz
                        </div>
                        <div className="checkout__left__mid__productInfo__style gren">In Stock</div>
                        <div className="checkout__left__mid__productInfo__style"><span>Style: </span>27" IPS 75Hz</div>
                        <div className="checkout__left__mid__productInfo__style"><span>Pattern: </span> Monitor</div>
